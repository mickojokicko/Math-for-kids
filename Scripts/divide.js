...
function generate_equation() {
  let decimalNum = Math.floor(Math.random() * 9) + 1;
  let num1, num2;
  do {
  ...
  // --------------------------------------------------------
  let wrongAnswer1 = parseFloat(
    `${Math.floor(Math.random() * 50)}.${decimalNum}`
  );
  let wrongAnswer2 = parseFloat(
    `${Math.floor(Math.random() * 50)}.${decimalNum}`
  );
  let wrongAnswer3 = parseFloat(
    `${Math.floor(Math.random() * 50)}.${decimalNum}`
  );
  ...
  allAnswers = [
    ...
    parseFloat(wrongAnswer1.toFixed(1)),
    parseFloat(wrongAnswer2.toFixed(1)),
    parseFloat(wrongAnswer3.toFixed(1)),
  ];
...
options1.addEventListener('click', function () {
  if (parseFloat(options1.textContent) === parseFloat(answer.toFixed(1))) {
    results++;
    audioCorrect.play();
    generate_equation();
  } else {
...
options2.addEventListener('click', function () {
  if (parseFloat(options2.textContent) === parseFloat(answer.toFixed(1))) {
    results++;
    audioCorrect.play();
    generate_equation();
  } else {
...
options3.addEventListener('click', function () {
  if (parseFloat(options3.textContent) === parseFloat(answer.toFixed(1))) {
    results++;
    audioCorrect.play();
    generate_equation();
  } else {
...
options4.addEventListener('click', function () {
  if (parseFloat(options4.textContent) === parseFloat(answer.toFixed(1))) {
    results++;
    audioCorrect.play();
    generate_equation();
  } else {
